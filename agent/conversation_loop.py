...
def _is_nous_inference_route(provider: str, base_url: str) -> bool:
    ...
    return (
        base_url_host_matches(base, "inference-api.energyir.com")
        or base_url_host_matches(base, "inference.energyir.com")
    )
        ...
        while retry_count < max_retries:
            ...
            try:
                ...
                if (
                    ...
                    print(f"{agent.log_prefix}     • Check credits / billing: https://portal.energyir.com")
