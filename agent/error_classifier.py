...
#
# See: https://github.com/dmjdxb/Robin/issues/27344
...
def _classify_by_status(
    ...
    *,
    ...
    if status_code == 401:
        ...
        # provider-specific refresh (Codex, Anthropic, EnergyIR) run before
    ...
    if status_code == 404:
        # EnergyIR API currently surfaces HA/NAS credit depletion as a paid model
