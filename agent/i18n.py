"""Lightweight internationalization (i18n) for Robin static user-facing messages.

Scope (thin slice, by design): only the highest-impact static strings shown
to the user by Robin itself -- approval prompts, a handful of gateway slash
...
def reset_language_cache() -> None:
    ...
    Call after :func:`robin.config.save_config` if a running process
