...
The version is sourced live from ``robin.__version__`` so it auto-aligns
...
``robin.__version__`` is the canonical source of truth.
"""
...
def nous_portal_tags() -> List[str]:
    ...
    """
    return ["product=hermes-agent", robin_client_tag()]
