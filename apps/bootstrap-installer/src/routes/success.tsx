...
import { launchRobinDesktop } from '../store'
 ...
 * had `onClick={() => void launchRobinDesktop()}` which swallowed
  ...
  return (
    <div className="hermes-fade-in flex h-full flex-col items-center justify-center gap-8 px-12 py-10">
      <div className="w-full max-w-2xl min-w-0 text-center">
        ...
        >
          <span>
            <span>Robin is ready</span>
          </span>
          <span aria-hidden="true">Robin is ready</span>
        </p>
