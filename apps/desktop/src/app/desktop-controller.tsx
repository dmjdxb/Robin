...
import { useRobinConfig } from './session/hooks/use-hermes-config'
...
export function DesktopController() {
  ...
  const { refreshRobinConfig, sttEnabled, voiceMaxRecordingSeconds } = useRobinConfig({
    activeSessionIdRef,
