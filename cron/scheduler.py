...
from robin._subprocess_compat import windows_hide_flags
from robin.config import load_config, _expand_env_vars
...
def _resolve_cron_enabled_toolsets(job: dict, cfg: dict) -> list[str] | None:
    ...
    if per_job:
        return per_job
    try:
        from robin.tools_config import _get_platform_tools  # lazy: avoid heavy import at cron module load
...
def _get_hermes_home() -> Path:
    """Resolve Robin home dynamically while preserving test monkeypatch hooks."""
...
def _job_profile_context(job_id: str, profile: Optional[str]):
    """Temporarily run a job under a specific Robin profile.
    ...
    the scheduler's test/override hook and a context-local Robin home override
    ...
    from robin.profiles import normalize_profile_name, resolve_profile_env
...
def tick(verbose: bool = True, adapters=None, loop=None, sync: bool = True) -> int:
    ...
    try:
        ...
        # Robin home override, scheduler _hermes_home hook, and temporary
