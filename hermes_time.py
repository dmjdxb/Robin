"""
Timezone-aware clock for Robin.
...
Invalid timezone values log a warning and fall back safely — Robin never
...
try:
    ...
    # Python 3.8 fallback (shouldn't be needed — Robin requires 3.9+)
