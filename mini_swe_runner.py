...
# ============================================================================
# Terminal Tool Definition (matches Robin-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Robin-Agent's built-in backends.
...
class MiniSWERunner:
    """
    Agent runner that uses Robin-Agent's built-in execution environments
    and outputs trajectories in Robin-Agent format.
    """
