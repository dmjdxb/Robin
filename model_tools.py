...
#   - cli.py, robin/*      -> inline on startup (no event loop)
...
def _compute_tool_definitions(
    ...
    # window). Core Robin tools (toolsets._HERMES_CORE_TOOLS) are NEVER
...
def _resolve_active_context_length() -> int:
    ...
    """
    try:
        from robin.config import load_config as _load
        cfg = _load() or {}
...
def _emit_post_tool_call_hook(
    *,
    ...
    """
    try:
        from robin.plugins import has_hook, invoke_hook
