...
version: 1.0.0
author: arceus77-7, enhanced by Robin
license: MIT
...
- `tmux` available for stable authenticated sessions during Robin terminal calls (desktop app flow only)
...
### Service Account (recommended for Robin)
...
## Robin Execution Pattern (desktop app flow)

Robin terminal commands are non-interactive by default and can lose auth context between calls.
