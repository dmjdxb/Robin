...
- User wants **Robin itself to drive a browser** → use Robin' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
