...
into the same ``DashboardAuthProvider`` framework as the EnergyIR OAuth
...
mirroring the EnergyIR provider's precedence convention:
...
Skip reasons:
  Like the EnergyIR provider, this exposes a module-level ``LAST_SKIP_REASON``
