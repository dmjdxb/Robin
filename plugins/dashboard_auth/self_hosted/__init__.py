...
:class:`~robin.dashboard_auth.DashboardAuthProvider` methods and touches
...
``robin/dashboard_auth/routes.py``; this provider only:
  ...
  4. verifies the **ID token** (RS256/ES256) against the discovered
     ...
     onto a :class:`~robin.dashboard_auth.Session`.
