...
#     fresh "Robin is thinking…" card during the small window between
...
class GoogleChatAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        # they don't sit in the chat forever as "Robin is thinking…".
    ...
    async def send_typing(self, chat_id: str, metadata: Any = None) -> None:
        """Post a visible 'Robin is thinking…' marker message.
        ...
        "Robin is thinking…" stuck in chat forever, plus one card that
        ...
        body: Dict[str, Any] = {"text": "Robin is thinking…"}
        if thread_id:
            body["thread"] = {"name": thread_id}
    ...
    async def stop_typing(self, chat_id: str) -> None:
        ...
        Google Chat has no separate typing API: the "Robin is thinking…"
    ...
    async def on_processing_complete(
        ...
        see "Robin is thinking…" stuck forever.
        """
    ...
    async def _consume_typing_card_with_text(
        ...
        creating a fresh "Robin is thinking…" card during any subsequent
...
def interactive_setup() -> None:
    ...
    The setup wizard at ``robin/gateway.py`` calls this for plugin
...
def register(ctx) -> None:
    """Plugin entry point — called by the Robin plugin system at startup.
    ...
    ctx.register_platform(
        ...
        # the "Robin is thinking..." marker patches and edit overhead.
        ...
        platform_hint=(
            ...
            "are generating a response, a 'Robin is thinking…' marker message "
