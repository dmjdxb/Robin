...
def _inherited_flag(parser, *args, **kwargs):
    """Register a flag that ``robin.relaunch`` should carry over when
...
Examples:
    ...
    hermes -s powerpoint,youtube-content
...
def build_top_level_parser():
    ...
    parser = argparse.ArgumentParser(
        prog="hermes",
        description="Robin - AI assistant with tool-calling capabilities",
    ...
    chat_parser = subparsers.add_parser(
        ...
        description="Start an interactive chat session with Robin",
    )
