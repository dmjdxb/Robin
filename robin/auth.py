...
from robin.config import get_hermes_home, get_config_path, read_raw_config
...
SPOTIFY_DOCS_URL = "https://robin.energyir.com/docs/user-guide/features/spotify"
SPOTIFY_DASHBOARD_URL = "https://developer.spotify.com/dashboard"
SPOTIFY_ACCESS_TOKEN_REFRESH_SKEW_SECONDS = 120

XAI_OAUTH_DOCS_URL = "https://robin.energyir.com/docs/guides/xai-grok-oauth"
OAUTH_OVER_SSH_DOCS_URL = "https://robin.energyir.com/docs/guides/oauth-over-ssh"
...
def _resolve_api_key_provider_secret(
    ...
    if provider_id == "copilot":
        ...
        try:
            from robin.copilot_auth import resolve_copilot_token, get_copilot_api_token
...
def resolve_provider(
    ...
    *,
    ...
    raise AuthError(
        "No EnergyIR API key found. Open Settings and paste your EnergyIR API "
...
# which does a synchronous OAuth refresh POST to portal.energyir.com. That can take
...
def _prompt_model_selection(
    ...
    """
    from robin.models import _format_price_per_mtok
...
def _save_model_choice(model_id: str) -> None:
    ...
    """
    from robin.config import save_config, load_config
...
def _minimax_oauth_login(
    *, region: str = "global", open_browser: bool = True,
    ...
    print(f"Starting Robin login via MiniMax ({region}) OAuth...")
...
def _nous_device_code_login(
    *,
    ...
    print(f"Starting Robin login via {pconfig.name}...")
    print(f"Portal: {portal_base_url}")
    if insecure:
