"""Slash command definitions and autocomplete for the Robin CLI.
...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("rollback", "List or restore filesystem checkpoints", "Session",
               args_hint="[number]"),
    CommandDef("snapshot", "Create or restore state snapshots of Robin config/state", "Session",
    ...
    CommandDef("steer", "Inject a message after the next tool call without interrupting", "Session",
               args_hint="<prompt>"),
    CommandDef("goal", "Set a standing goal Robin works on across turns until achieved", "Session",
    ...
    CommandDef("busy", "Control what Enter does while Robin is working", "Configuration",
    ...
    CommandDef("update", "Update Robin to the latest version", "Info"),
...
def _iter_plugin_command_entries() -> list[tuple[str, str, str]]:
    ...
    :func:`robin.plugins.PluginContext.register_command`. They behave
...
Telegram only displays a small BotCommand menu in practice.  The full Robin
...
def slack_native_slashes() -> list[tuple[str, str, str]]:
    ...
    entries.append(("hermes", "Talk to Robin or run a subcommand", "[subcommand] [args]"))
    seen.add("hermes")
