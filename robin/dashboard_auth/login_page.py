...
Visual styling mirrors the EnergyIR design system (the
...
``tests/robin/test_dashboard_auth_401_reauth.py``.
"""
...
<body>
<main>
  <div class="brand">EnergyIR<span class="dot"></span>Research</div>
  <div class="card">
    <h1>Sign in</h1>
    <p class="subtitle">Choose a sign-in method to continue to the Robin dashboard.</p>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Sign-in unavailable — Robin</title>
<style>
  @font-face {
    font-family: 'Collapse';
    font-style: normal;
