...
Outputs a compact, plain-text summary of the user's Robin setup
...
from robin.config import get_hermes_home, get_env_path, get_project_root, load_config
...
def _get_git_commit(project_root: Path) -> str:
    ...
    ``HERMES_GIT_SHA`` build-arg (see ``robin/build_info.py``).
...
def _gateway_status() -> str:
    ...
    try:
        from robin.gateway import get_gateway_runtime_snapshot
