...
def _restore_auth_active_provider(value: Any) -> None:
    ...
    try:
        from robin.auth import _auth_store_lock, _load_auth_store, _save_auth_store
...
def cmd_fallback_list(args) -> None:  # noqa: ARG001
    ...
    print("  Docs: https://robin.energyir.com/docs/user-guide/features/fallback-providers")
    print()
...
def cmd_fallback_add(args) -> None:
    ...
    from robin.main import _require_tty, select_provider_and_model
