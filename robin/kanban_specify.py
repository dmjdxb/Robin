...
* This module intentionally mirrors ``robin/goals.py`` — same aux
...
_SYSTEM_PROMPT = """You are the Kanban triage specifier for the Robin board.
...
def _profile_author() -> str:
    """Mirror of ``robin.kanban._profile_author``. Kept local to
