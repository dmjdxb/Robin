...
from robin.cli_output import prompt as _prompt_input
...
def _probe_tools(name: str) -> Optional[List[tuple]]:
    ...
    try:
        ...
        from robin.mcp_config import _probe_single_server
...
def install_entry(entry: CatalogEntry, *, enable: bool = True) -> None:
    ...
    print(color(
        ...
        f"Start a new Robin session to load its tools.",
        Colors.GREEN,
    ))
