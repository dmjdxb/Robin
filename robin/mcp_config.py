...
def _prompt(question: str, *, password: bool = False, default: str = "") -> str:
    from robin.cli_output import prompt as _shared_prompt
...
def _oauth_tokens_present(name: str) -> bool:
    ...
    try:
        ...
        return RobinTokenStorage(name).has_cached_tokens()
...
def cmd_mcp_add(args):
    ...
    # robin/main.py for why the dest is renamed.
...
def mcp_command(args):
    ...
    if handler:
        ...
        _info("hermes mcp catalog                            List EnergyIR-approved MCPs")
