...
Design notes
------------
- Mirrors the shape of ``robin/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are a profile-describer for the Robin kanban board.
...
Rules:
  ...
  - Never write "Robin profile" or other meta-narration.
