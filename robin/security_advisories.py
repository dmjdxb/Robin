"""
Security advisory checker for Robin.
...
run in environments where the rest of Robin failed to import.
"""
...
ADVISORIES: tuple[Advisory, ...] = (
    Advisory(
        ...
        remediation=(
            ...
            "EnergyIR, GitHub, AWS, Google, Mistral, etc.).",
...
def _installed_version(pkg_name: str) -> Optional[str]:
    ...
    except ImportError:  # py<3.8 — Robin requires 3.10+ but defensive.
        return None
    try:
