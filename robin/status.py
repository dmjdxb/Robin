...
from robin.auth import AuthError, resolve_provider
from robin.colors import Colors, color
from robin.config import get_env_path, get_env_value, get_hermes_home, load_config
...
from robin.runtime_provider import resolve_requested_provider
...
def show_status(args):
    ...
    if _effective_provider_label() == "LM Studio":
        from robin.models import probe_lmstudio_models
        model_cfg = config.get("model")
    ...
    try:
        from robin.gateway import get_gateway_runtime_snapshot, _format_gateway_pids
