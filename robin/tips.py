...
TIPS = [
    ...
    "Ctrl+Z suspends Robin to the background — run fg in your shell to resume.",
    ...
    "hermes mcp serve runs Robin itself as an MCP server for other agents.",
    ...
    "hermes backup creates a zip backup of your entire Robin home directory.",
    ...
    "hermes gateway install sets up Robin as a system service (systemd/launchd).",
    ...
    # --- Tools & Capabilities ---
    "execute_code runs Python scripts that call Robin tools programmatically — results stay out of context.",
    ...
    "When exiting, Robin prints a resume command with session ID and stats.",
    ...
    # --- Gateway & Messaging ---
    "Robin runs on 21 messaging platforms: Telegram, Discord, Slack, WhatsApp, Signal, Matrix, IRC, Microsoft Teams, email, and more.",
    ...
    "BlueBubbles brings iMessage to Robin via a local macOS server.",
    ...
    "Robin loads project context from .hermes.md, AGENTS.md, CLAUDE.md, or .cursorrules (first match).",
    ...
    # --- MCP ---
    "hermes mcp opens an interactive picker of EnergyIR-approved MCPs you can install in one keystroke.",
    "hermes mcp catalog lists EnergyIR-approved MCP servers shipped with the repo.",
    ...
    "hermes acp runs Robin as an ACP server for VS Code, Zed, and JetBrains integration.",
    ...
    "SOUL.md completely replaces the agent's default identity — rewrite it to make Robin your own.",
    ...
    "Before a gateway session reset, Robin auto-flushes important facts to memory in the background.",
    ...
    '/goal <text> sets a standing Ralph-loop objective — Robin auto-continues turn after turn until a judge says done.',
    '/snapshot create [label] saves a full state snapshot of Robin config; /snapshot restore <id> reverts later.',
    ...
    '/busy queue|steer|interrupt controls what pressing Enter does while Robin is working.',
    ...
    'use_gateway: true per-tool routes web, image, tts, or browser through your EnergyIR subscription — no extra keys.',
    ...
    'hermes dashboard embeds the full Robin TUI in your browser via xterm.js and a WebSocket PTY.',
    ...
    # --- Security ---
    'security.tirith_fail_open: false makes Robin block commands when the tirith scanner itself errors out.',
