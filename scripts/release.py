...
VERSION_FILE = REPO_ROOT / "robin" / "__init__.py"
...
AUTHOR_MAP = {
    ...
    "shannon@energyir.com": "shannonsands",
    ...
    "hermes@energyir.com": "NousResearch",
    ...
    "emozilla@energyir.com": "emozilla",
    ...
    "clement@energyir.com": "lemassykoi",  # PR #27042 (model-switch probe keyless providers)
...
def parse_coauthors(body: str) -> list:
    ...
    _ignored_emails = {"noreply@anthropic.com", "noreply@github.com",
                       "cursoragent@cursor.com", "hermes@energyir.com"}
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/dmjdxb/Robin",
