...
Built for [Robin](https://github.com/dmjdxb/Robin). Usable in any coding agent. Canonical source lives here; synced to [`dmjdxb/Robin/skills/creative/ascii-video`](https://github.com/dmjdxb/Robin/tree/main/skills/creative/ascii-video) via PR.
