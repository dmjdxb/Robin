...
|--------|----------|--------|
| Metadata namespace | `openclaw` | `robin` |
...
| File operations | Bash commands | Robin file tools (write_file, read_file) |
...
Reference files can be overwritten directly (they're unchanged from upstream). SKILL.md must be manually merged since it contains Robin-specific adaptations.
