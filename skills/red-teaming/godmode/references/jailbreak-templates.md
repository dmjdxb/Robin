...
## 5. GODMODE FAST — Robin 4 405B (Zero Refusal)

**Model:** `nousresearch/hermes-4-405b`
**Strategy:** Robin models are already uncensored, so this combo is about speed — instant token streaming with zero refusal checking needed. Uses the same Pliny Love divider format as a formality.
...
Pick a template above and set it in `~/.robin/config.yaml`:
