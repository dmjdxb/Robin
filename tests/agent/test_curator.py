...
def test_cli_unpin_refuses_bundled_skill(curator_env, capsys):
    ...
    from robin import curator as cli
    skills_dir = curator_env["home"] / "skills"
...
def test_curator_slot_is_canonical_aux_task():
    ...
    from robin.main import _AUX_TASKS
    from robin.web_server import _AUX_TASK_SLOTS
    ...
    # 3. robin/web_server.py _AUX_TASK_SLOTS — REST API allowlist
