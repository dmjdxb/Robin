...
def cli_obj(_isolate):
    """Create a minimal RobinCLI instance for banner testing."""
...
class TestLowContextWarning:
    ...
    def test_warning_for_below_minimum_context(self, cli_obj):
        """Warning shown when context is below Robin' minimum."""
    ...
    def test_no_warning_at_boundary(self, cli_obj):
        """No warning at exactly Robin' minimum context length."""
    ...
    def test_no_warning_above_boundary(self, cli_obj):
        """No warning above Robin' minimum context length."""
