...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("robin.config.get_config_path", return_value=config_path), \
             patch("robin.config.ensure_hermes_home"):
    ...
    def test_save_env_value_sets_0600(self):
        ...
        with patch("robin.config.get_env_path", return_value=env_path), \
             patch("robin.config.ensure_hermes_home"):
    ...
    def test_ensure_hermes_home_sets_0700(self):
        ...
        with patch("robin.config.get_hermes_home", return_value=home):
