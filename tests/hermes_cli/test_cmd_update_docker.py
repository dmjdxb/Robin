...
host-side Robin, not an update to the running container, so the message
...
from robin.main import _cmd_update_check, cmd_update
...
@patch("robin.config.detect_install_method", return_value="docker")
