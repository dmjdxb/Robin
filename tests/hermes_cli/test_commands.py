...
from robin.commands import discord_skill_commands_by_category  # noqa: E402
...
class TestPluginCommandEnumeration:
    ...
    def _patch_plugin_commands(self, monkeypatch, commands):
        """Monkeypatch robin.plugins.get_plugin_commands() to a fixed dict."""
        from robin import plugins as _plugins_mod
