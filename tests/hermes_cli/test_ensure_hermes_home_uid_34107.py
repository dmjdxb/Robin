...
When Robin runs in Docker with ``HERMES_UID=1000`` / ``HERMES_GID=911``,
...
class TestResolveRobinUidGid:
    def test_returns_parsed_values_when_both_set(self, monkeypatch):
        ...
        from robin.config import _resolve_hermes_uid_gid
