"""Tests for robin.uninstall.remove_node_symlinks.
...
only when they still resolve into the Robin-managed node dir.
"""
...
import robin.uninstall as uninstall
...
def test_only_some_links_present(fake_home):
    ...
    # Only npm and npx are Robin-managed; node is a real user binary.
