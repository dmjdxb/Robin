...
# helper (and need the autouse stub in tests/robin/conftest.py disabled),
...
def test_quarantine_actionable_warning_when_everything_fails(
    ...
    assert "Robin Desktop" in captured or "gateway" in captured.lower()
