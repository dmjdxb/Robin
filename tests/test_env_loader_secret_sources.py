"""Tests for the secret-source tracking in ``robin.env_loader``.
...
from robin import env_loader  # noqa: E402
...
def test_apply_external_secret_sources_dedupes_within_process(tmp_path, monkeypatch):
    ...
    hot modules (cli.py, robin/main.py, run_agent.py, ...).  The
    ...
    # cli.py, robin/main.py, run_agent.py, trajectory_compressor.py,
