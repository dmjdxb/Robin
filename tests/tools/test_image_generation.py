...
class TestGptQualityPinnedToMedium:
    ...
    and cannot be overridden via config. Pinning keeps Together AI billing
    ...
    def test_config_quality_setting_is_ignored(self, image_tool):
        ...
        with patch("robin.config.load_config",
...
class TestManagedGatewayErrorTranslation:
    """4xx from the EnergyIR managed gateway should be translated to a user-actionable message."""
