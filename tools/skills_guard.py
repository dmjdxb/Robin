...
Trust levels:
  - builtin:   Ships with Robin. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.hermes/\.env|\~/\.hermes/\.env',
     ...
     "directly references Robin secrets file"),
    ...
    (r'\.hermes/config\.yaml|\.hermes/SOUL\.md',
     ...
     "references Robin configuration files directly"),
...
# scan. `.skillignore` is the Robin-native name; `.clawhubignore` is honored
