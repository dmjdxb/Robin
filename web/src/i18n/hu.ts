...
export const hu: Translations = {
  ...
  status: {
    ...
    stopped: "Leállítva",
    updateRobin: "Robin frissítése",
    updatingRobin: "Robin frissítése…",
  ...
  pluginsPage: {
    ...
    headline:
      "Robin-bővítmények felfedezése, telepítése, engedélyezése és frissítése (a `robin plugins` paritás).",
  ...
  achievements: {
    ...
    stats: {
      ...
      latest: "Legutóbbi",
      latest_hint_empty: "futtasd többet a Robint",
      none_yet: "Még semmi",
    },
    state: {
      unlocked: "Feloldva",
