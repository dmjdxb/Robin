 ...
 *
 * Versioning: bump ``RobinPluginSDK["sdkVersion"]`` (and the
...
export interface RobinPluginSDK {
  ...
  /**
   * Shared UI primitives (EnergyIR DS / shadcn). Typed permissively at the
...
declare global {
  interface Window {
    __HERMES_PLUGIN_SDK__?: RobinPluginSDK;
